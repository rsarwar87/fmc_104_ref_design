...
#
# Generated by export_simulation on Thu Aug 22 21:37:57 BST 2019
#
################################################################################
...
'-reset_run' switch to the './MercuryZX1.sh' script.

./MercuryZX1.sh -reset_run
...
./MercuryZX1.sh -noclean_files

For more information on the script, please type './MercuryZX1.sh -help'.
