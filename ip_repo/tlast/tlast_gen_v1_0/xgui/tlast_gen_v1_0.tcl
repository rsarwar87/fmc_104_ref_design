...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PKT_LENGTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TDATA_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.PKT_LENGTH { PARAM_VALUE.PKT_LENGTH } {
	# Procedure called to update PKT_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PKT_LENGTH { PARAM_VALUE.PKT_LENGTH } {
	# Procedure called to validate PKT_LENGTH
	return true
}
...
proc update_MODELPARAM_VALUE.PKT_LENGTH { MODELPARAM_VALUE.PKT_LENGTH PARAM_VALUE.PKT_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PKT_LENGTH}] ${MODELPARAM_VALUE.PKT_LENGTH}
}
